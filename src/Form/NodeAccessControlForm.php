...
// phpcs:disable Drupal.Commenting.DocComment.Empty
// @todo Re-enable after fixing the errors and after refactoring.
// phpcs:disable DrupalPractice.Objects.GlobalDrupal.GlobalDrupal
// phpcs:disable DrupalPractice.Objects.GlobalFunction.GlobalFunction
...
class NodeAccessControlForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, ?NodeInterface $node = NULL) {
    ...
    $access_control_field = Utilities::getAccessControlFieldinNode($node);
    // Utilities::getIslandoraAccessTerms();
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $operations = [
          ['\Drupal\islandora_group\Utilities::taggingFieldAccessTermsNode', [$form_state->getValues()['nid'], $targets]],
    ];
    ...
    if (isset($form_state->getValues()['access-control']['media']['access-control'])) {
      ...
      foreach ($selected_media as $media_id) {
        ...
        $operations[] = ['\Drupal\islandora_group\Utilities::taggingFieldAccessTermMedia', [$media, $targets]];
      }
    }
    ...
    if (isset($form_state->getValues()['access-control']['children-nodes']['access-control'])) {
      ...
      foreach ($children_nodes as $cnid) {
        ...
        $operations[] = ['\Drupal\islandora_group\Utilities::taggingFieldAccessTermsNode', [$cnid, $targets]];
        ...
        foreach ($child_medias as $child_media) {
          $operations[] = ['\Drupal\islandora_group\Utilities::taggingFieldAccessTermMedia', [$child_media, $targets]];
        }
      }
    }
